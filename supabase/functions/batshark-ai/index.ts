...
serve(async (req) => {
  ...
  آخر 3 أشهر: ${lastMonths || 'لا توجد بيانات'}`;
    ...
    const COMPANY_CONTEXT = `أنت "BatShark AI" — المستشار التنفيذي الاقتصادي لشركة BatShark Economy.
...
- إذا كان الرقم صفر أو لا توجد بيانات، قل ذلك بوضوح بدلاً من اختراع أرقام.
- أجوبتك مختصرة ومهنية مع أرقام دقيقة ونسب مئوية.
- قدّم توصيات عملية قابلة للتنفيذ مع كل تحليل.
- عند وجود خطر مالي: "⚠️ تنبيه: [وصف دقيق مع أرقام]"
- قارن المشاريع ببعضها وقيّم الأداء نسبياً.
- حلل الاتجاهات الشهرية إذا توفرت بيانات.
